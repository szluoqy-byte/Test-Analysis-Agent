...
4. 只选择与本次需求直接相关的条目，生成 `${PROJECT_ROOT}/outputs/runs/<run-id>/process/context-pack.md`。
5. 后续需求分析、方法路由、设计输入生成和覆盖审查只读取当前 run 的 `context-pack.md`。
6. 过程分析报告给出“建议沉淀的 Memory 更新”。
